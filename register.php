...
<?php
  ...
  <div class="input-group mb-3">
    ...
    <input type="text" name="name" class="form-control" placeholder="Enter your first Name" aria-label="name" aria-describedby="basic-addon1" maxlength="50" value="<?php echo $fname ?>" />
  ...
  <div class="input-group mb-3">
    ...
    <input type="text" name="name" class="form-control" placeholder="Enter your Last Name" aria-label="name" aria-describedby="basic-addon1" maxlength="50" value="<?php echo $lname ?>" />
    <span class="text-danger"><?php echo $nameError; ?></span>
  </div>
